package gse1.buergerbusserver.general.common.api.exception;

import gse1.buergerbusserver.general.common.api.NlsBundleApplicationRoot;

/**
 * This exception is thrown if an {@link gse1.buergerbusserver.general.common.api.ApplicationEntity entity} has
...
public class IllegalEntityStateException extends ApplicationBusinessException {
   ...
   *
   * @param entity the entity that caused this error.
   * @param currentState the state of the buergerbusserverEntity entity.
